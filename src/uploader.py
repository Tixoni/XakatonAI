"""
Модуль для загрузки файлов в S3 (Yandex Object Storage)
"""
import os
...
def upload_file(local_path: str, remote_name: Optional[str] = None) -> bool:
    """
    Загружает файл в S3 (Yandex Object Storage)
    
    Args:
        local_path: путь к локальному файлу
        remote_name: имя файла в S3 (если None, используется имя локального файла)
